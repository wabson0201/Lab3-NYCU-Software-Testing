...
public class PriorityQueueTest {
    static Stream<Arguments> stringIntAndListProvider() {
        return Stream.of(
                ...
                Arguments.of(new int[]{-3,-1,-2,5}, new int[]{5,-2,-1,-3}),
                Arguments.of(new int[]{3,-2,-5,-1,2}, new int[]{3,-2,-1,2,-5}),
                Arguments.of(new int[]{-3,1,11,0,9,3}, new int[]{11,0,1,3,9,-3}),
                Arguments.of(new int[]{3,7,2,-1,-2}, new int[]{7,-1,2,3,-2})
        );
    }
