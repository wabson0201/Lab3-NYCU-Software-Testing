...
public class PriorityQueueTest {
    static Stream<Arguments> stringIntAndListProvider() {
        return Stream.of(
                Arguments.of(new int[]{3,1,2}, new int[]{99,1,2,3}),
                Arguments.of(new int[]{-3,-1,-2,5}, new int[]{99,-3,-2,-1,5}),
                Arguments.of(new int[]{3,-2,-5,-1,2}, new int[]{99,-5,-2,-1,2,3}),
                Arguments.of(new int[]{-3,1,11,0,9,3}, new int[]{99,-3,0,1,3,9,11}),
                Arguments.of(new int[]{3,7,2,-1,-2}, new int[]{99,-2,-1,2,3,7})
        );
    }
